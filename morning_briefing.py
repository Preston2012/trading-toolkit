...
import ccxt, json, os, requests, schedule, time
...
def morning_briefing():
    ...
    try:
        ...
        if to_strike < 3: msg += "  STATUS: APPROACHING STRIKE\n"
        elif to_strike < 5: msg += "  STATUS: Getting close\n"
        else: msg += "  STATUS: Needs more oil upside\n"
    except: pass
    # Regime status
    try:
...
if __name__ == "__main__":
    ...
    morning_briefing()  # Send immediately on start
    schedule.every().day.at("12:30").do(morning_briefing)  # 12:30 UTC = 8:30 ET
    while True:
